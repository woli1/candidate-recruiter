...
import { fetchCandidatelistData } from 'src/app/recruiter/store/Candidate/candidate.actions';
import { selectData } from 'src/app/recruiter/store/Candidate/candidate-selector';
