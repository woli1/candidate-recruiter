...
import { adduserlist, deleteuserlist, fetchuserlistData, updateuserlist } from 'src/app/recruiter/store/UserList/userlist.action';
import { selectData } from 'src/app/recruiter/store/UserList/userlist-selector';
...
@Component({
  ...
  standalone:true,
  imports:[CommonModule,PagetitleComponent,FormsModule,PaginationModule,ReactiveFormsModule,BsDropdownModule,ModalModule]
})
