...
import { fetchJobgridData } from 'src/app/recruiter/store/Job/job.action';
import { selecDatagrid } from 'src/app/recruiter/store/Job/job-selector';
...
export class GridComponent implements OnInit {
  ...
  page: 1;
  term: any
  constructor(private candidacyService:CandidacyService,private formBuilder: UntypedFormBuilder, private modalService: BsModalService, public store: Store) { }
...
*/
    ...
    this.candidacyService.getCandidacyByCandidate(1).subscribe(data => {
      this.grids = data;
      this.gridata = data;
