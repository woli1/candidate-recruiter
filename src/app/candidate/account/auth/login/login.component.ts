...
import { login } from 'src/app/recruiter/store/Authentication/authentication.actions';
...
export class LoginComponent implements OnInit {
  ...
  ngOnInit() {
    if (localStorage.getItem('currentUser')) {
      this.router.navigate(['/candidate/profile/1']);
    }
    // form validation
  ...
  onSubmit() {
    ...
    this.router.navigateByUrl("/candidate/profile/1");
  }
