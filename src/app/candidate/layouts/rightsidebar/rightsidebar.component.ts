...
import { LayoutState, initialState } from 'src/app/candidate/store/layouts/layouts.reducer';
import { Store } from '@ngrx/store';
import { changeLayoutWidth, changeMode, changeSidebarMode } from 'src/app/candidate/store/layouts/layout.actions';
import { getLayoutMode, getLayoutWidth, getsidebar } from 'src/app/candidate/store/layouts/layout.selector';
import { RootReducerState } from 'src/app/candidate/store';
import { changesLayout } from 'src/app/candidate/store/layouts/layout.actions';
